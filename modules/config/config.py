...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", "-1001808259202"))
COMMAND_PREFIXES = list(getenv("COMMAND_PREFIXES", "/ ! .").split())
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "ʀᴏᴍᴇᴏ ᴍᴜsɪᴄ")
OWNER_ID = list(map(int, getenv("OWNER_ID", "5247304559").split()))
HEROKU_API_KEY = getenv("HEROKU_API_KEY")
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME")
UPSTREAM_REPO = getenv("UPSTREAM_REPO","https://github.com/Hyper-x-Rachit/lucky",)
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "bikash")
GIT_TOKEN = getenv("GIT_TOKEN", None)
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/The_Secret_Chatting_Society")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/Doston_Ki_Masti")
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://t.me/HYPERXRACHIT")
...
START_IMG_URL = getenv("START_IMG_URL", f"https://telegra.ph/file/843619cbc2923a2f33a94.jpg")
